...
![](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:peripherals:pwm_oneshot_mode.jpg "Figure 3 One shot mode")
...
![](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:peripherals:pwm_upcount_mode.jpg "Figure 4 Up count mode")
...
![](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:peripherals:pwm_downcount_mode.jpg "Figure 5 Down count mode")
...
![](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:peripherals:pwm_counter_mode1.jpg "Figure 6 Counter mode with rising edge")

The below Figure is with falling edge mode.
![](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:peripherals:pwm_counter_mode2.jpg "Figure 7 Counter mode with falling edge")

The below Figure is with both rising and falling edge mode.
![](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:peripherals:pwm_counter_mode3.jpg "Figure 8 Counter mode with rising and falling edge")
...
![](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:peripherals:pwm_timing_diagram1.jpg "Figure 9 Timer/Counter timing diagram with match interrupt")

The below Figure Timer/Counter timing diagram with overflow interrupt.

![](http://wizwiki.net/wiki/lib/exe/fetch.php?media=products:w7500:peripherals:pwm_timing_diagram2.jpg "Figure 10 Timer/Counter timing diagram with overflow interrupt")
